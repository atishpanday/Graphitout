            ...
            {csvData.length > 0 ? (
                <div className="h-full w-full max-h-full flex flex-col">
                        ...
                        <div className="flex">
                            <DropDown
                                ...
                                setSelected={(selected) =>
                                    setColorScheme(selected as ColorScheme)
                                }
                                items={colorSchemes}
                            />
                        </div>
                    ...
                    {x.length > 0 && y.length > 0 ? (
                        ...
                        <iframe
                            src="https://lottie.host/embed/fabd2e03-010a-48f7-aa24-977d12c96253/0EZDPzi5lQ.json"
                            height={"100%"}
                            width={"100%"}
                        />
                    )}
                    {x.length > 0 && y.length > 0 && (
                        <div className="w-full flex justify-end items-center bg-gray-100 shadow-md p-2">
                            ...
                            <div
                                ...
                                className={`${
                                    !modalOpen && "hidden"
                                } h-full w-full p-12 bg-white bg-opacity-50 fixed top-0 right-0 left-0 z-50 justify-center items-center`}
                            >
